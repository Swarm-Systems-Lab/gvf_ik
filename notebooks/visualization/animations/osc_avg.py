...
class AnimationOscAvg:
    ...
    def config_axes(self):
        ...
        self.ax2.set_ylabel(r"$\dot{\bar x}$ [m/s]")
        self.ax2.grid(True)
    ...
    def init_figure(self):
        ...
        for i in range(self.N):
            ...
            ax2_line, = self.ax2.plot(self.tdata[0], self.x_dot_avg[0,i], "k", lw=1.5)
    ...
    def gen_animation(self, fps=None, wait_period=3, factor=1):
        ...
        self.x_dot_anim = self.x_dot_avg[0:len(self.tdata):factor,:]
        self.A_anim = self.A
